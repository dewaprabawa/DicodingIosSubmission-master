...
class OverseeTourController:UITableViewController, PushNavigationController{
   
    var local = DestinationDataSource().destinationLine[1]
...
extension OverseeTourController {
